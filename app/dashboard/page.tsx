  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#F8F9FD]">
      ...
      <div className="flex-1 p-6 md:p-10">
        ...
        {/* Dynamic Project Feed with Mobile Scroll Fix */}
      ...
      <div className="w-full lg:w-[380px] p-6 md:p-10 space-y-10 border-l border-slate-100 bg-white/50 backdrop-blur-sm">
